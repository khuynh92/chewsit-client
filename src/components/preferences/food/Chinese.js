...
import phoIcon from '../../../assets/food/chinese.jpg';
  ...
  render() {
    return (
      <div className={!this.props.checked ? this.props.classes.container : this.props.checked}>
        ...
        <Typography className={this.props.classes.text} variant='body1'>Chinese Food</Typography>
      </div>
...
export default withStyles(styles)(Chinese);