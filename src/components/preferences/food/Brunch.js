...
import phoIcon from '../../../assets/food/brunch.jpg';
  ...
  render() {
    return (
      <div className={!this.props.checked ? this.props.classes.container : this.props.checked}>
        ...
        <Typography className={this.props.classes.text} variant='body1'>Brunch</Typography>
      </div>
...
export default withStyles(styles)(Brunch);