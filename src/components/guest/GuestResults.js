...
import Restaurant from '../results/Restaurant.js';
import RestInfo from '../results/RestInfo.js';
...
import {styles} from '../../style/guestResultsStyles.js';
...
class Results extends Component {
  ...
  nextRestaurant = async () => {
    if (this.state.index < 2 && this.state.index < this.props.resultsState.allResults.length) {
      ...
      this.setState({ endOfResults: true, openDialog: true }, () => console.log(this.state));
      ...
      return (
        <Fragment>
          ...
          >
            ...
            <Link to='/guest/dashboard' style={{ textDecoration: 'none' }}>
